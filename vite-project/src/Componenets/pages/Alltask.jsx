...
export default function Alltask() {
  ...
  const [tasks, setTasks] = useState(dataContext.tasks); // Initialize tasks state
  ...
  return (
    <div className="grid grid-cols-3 h-full gap-5">
      {tasks.map((task, index) => (
        <div
          className="flex flex-col bg-blue-100 h-64  rounded-2xl shadow-md p-1 m-3 hover:bg-blue-100 transition duration-300 ease-in-out"
          key={index}
        >
